...
`read` is derived from whether `## Notes` holds anything — prose of your own, or
quotes recovered from the PDF — so it states a fact about the note rather than a
claim you have to keep true. Empty that section and it comes off again. An
